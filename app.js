...
//       res.send(
//         "You need to specify a room name in the path (e.g. https://127.0.0.1/sfu/room1)"
//       );
//     });
...
//       console.log("just joined", { roomName, socketId, producerId });
//       producers.forEach((producerData) => {
//         if (
//           producerData.socketId !== socketId &&
//           producerData.roomName === roomName
//         ) {
//           console.log("informing", producerData.socketId);
//           const producerSockets = peers[producerData.socketId].socket;

//           producerSockets.emit("new-producer", { producerId });
//         }
//       });
//     };
...
//         peerDetails: {
//           displayName: "",
//           isAdmin: false // Is peer the admin of the room
//         }
//       };
...
//       // get the router from rooms object based on the peer's room name
...
//     socket.on("getProducer", (callback) => {
...
//         //  add prodcer to the producer array
//         const { roomName } = peers[socket.id];
...
//         (consumerData) => consumerData.socketId === serverConsumerId
//       ).consumer;
